        ...
        if (iterRigettoMancataIntegrazioneInstance) {
            if (params.version) {
                ...
                if (iterRigettoMancataIntegrazioneInstance.version > version) {
                    ...
                    iterRigettoMancataIntegrazioneInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'iterRigettoMancataIntegrazione.label', default: 'IterRigettoMancataIntegrazione')] as Object[], "Another user has updated this IterRigettoMancataIntegrazione while you were editing")
