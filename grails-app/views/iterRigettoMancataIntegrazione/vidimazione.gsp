        ...
        <div id="modifica_pratica">
            ...
            <g:hiddenField name="id" value="${iterRigettoMancataIntegrazioneInstance?.id}" />
                ...
                <div class="buttons_multipli">
                    <span class="button">
                    	<g:actionSubmit class="save" action="performVidimazione" value="Approva" />
                    </span>
                    <span class="button">
                    	<g:actionSubmit class="save" action="performVidimazione" value="Respingi" />
                    </span>
                    <%-- 
